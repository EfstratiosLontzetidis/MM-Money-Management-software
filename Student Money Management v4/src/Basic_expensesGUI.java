...
public class Basic_expensesGUI extends JFrame {
	...
	public Basic_expensesGUI() {
		...
		JButton btnNewButton = new JButton("\u039A\u03B1\u03C4\u03B1\u03C7\u03CE\u03C1\u03B9\u03C3\u03B7");
					...
					try {
						...
						try {
					        ...
					        while((st=br.readLine())!=null){
					        	PrintWriter output = new PrintWriter(st+"_be.txt");
					        	...
					        	PrintWriter output2 = new PrintWriter(st+"_tbe.txt");
					        	output2.print(syn);
		...
		btnNewButton.setBounds(313, 214, 105, 35);
