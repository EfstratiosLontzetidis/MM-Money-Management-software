...
public class Menu extends JFrame {
	...
	public Menu() {
		...
		button_2.setBounds(139, 192, 170, 23);
		...
		button_3.setBounds(139, 226, 170, 23);
		...
		btnNewButton_2.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					if(dayint==0||dayint>days||monthint>12||monthint==0||yearint<1990) {
						JOptionPane.showMessageDialog(null, "Λάθος Είσοδο! Προσπαθήστε Ξανά");
					}
					else {
						File dateC=new File("date.txt");
						try {
