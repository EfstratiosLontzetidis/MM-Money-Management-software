	...
	public Unexpected_incomeGUI() {
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (aprooptad<0){
					JOptionPane.showMessageDialog(null, "Λάθος Είσοδος! Δοκιμάστε ξανά.");
				}
				else {
					...
					try {
						...
						try {
					        ...
					        while((st=br.readLine())!=null){
					        	...
					        	BufferedReader br1=new BufferedReader(new FileReader(st+"_ti.txt"));
					        	String st1;
					        	while((st1=br1.readLine())!=null){
					        		double value=Double.parseDouble(st1);
					        		double syn=value+aprooptad;
					        		PrintWriter output = new PrintWriter(st+"_ti.txt");
						        	output.print(syn);
									output.close();}
					        		...
					        		if (f.exists()){
						        		...
						        		while((st2=br2.readLine())!=null){
						        			...
						        			PrintWriter output2 = new PrintWriter(st+"_yp.txt");
						        			output2.print(syn2);
						        			output2.close();
						        		}
					        		}
